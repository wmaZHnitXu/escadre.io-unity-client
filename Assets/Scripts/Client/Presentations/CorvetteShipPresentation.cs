// File: Scripts/Client/Presentations/CorvetteShipPresentation.cs
...
public class CorvetteShipPresentation : ClientProxyPresentation
{
    [Header("CorvetteShipPresentation Visuals")]
    ...
    protected override void OnInitialized()
    {
        ...
        if (_shipProxy == null)
        {
            Logger.LogError($"[CorvetteShipPresentation {gameObject.name}] TargetProxy is not a ShipProxy.ClientProxy! Type: {TargetProxy?.GetType().Name}");
            enabled = false;
            return;
        }
        ...
        {
            Logger.LogWarning($"[CorvetteShipPresentation {gameObject.name}] ClientComposer not found in scene. Cannot determine advanced tap area states.");
        }
