// File: Scripts/Client/Presentations/SpeedboatShipPresentation.cs
...
public class SpeedboatShipPresentation : ClientProxyPresentation
{
    [Header("SpeedboatShipPresentation Visuals")]
    ...
    protected override void OnInitialized()
    {
        ...
        if (_shipProxy == null)
        {
            Logger.LogError($"[SpeedboatShipPresentation {gameObject.name}] TargetProxy is not a ShipProxy.ClientProxy! Type: {TargetProxy?.GetType().Name}");
            enabled = false;
            return;
        }
        ...
        {
            Logger.LogWarning($"[SpeedboatShipPresentation {gameObject.name}] ClientComposer not found in scene. Cannot determine advanced tap area states.");
        }
